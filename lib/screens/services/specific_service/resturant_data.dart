...
class SpecificResturant extends StatefulWidget {
  final ServiceData model;
  const SpecificResturant({Key? key, required this.model}) : super(key: key);

  @override
  State<SpecificResturant> createState() => _SpecificResturantState();
}

class _SpecificResturantState extends State<SpecificResturant> {
  int _currentPage = 0;
                        ...
                        InkWell(
                          onTap: () {
                            showModalBottomSheet(
                                ...
                                builder: (context) =>
                                    BlocProvider<GetMenusCubit>(
                                      create: (context) => GetMenusCubit()
                                        ..getMenus(sectionID: widget.model.iD!),
                                      child: BlocConsumer<GetMenusCubit,
                                          GetMenusStates>(
                                        listener: (context, state) {},
                                                        ...
                                                        GetMenusCubit.get(
                                                            ...
                                                            ? GridView.builder(
                                                                ...
                                                                itemBuilder: (context,
                                                                  ...
                                                                  child: mainCachedImage(
                                                                      url:
                                                                          'http://tasha.accessline.ps/${GetMenusCubit.get(context).menus![index].fileName!}'),
                                                                ),
                                                                itemCount:
                                                                    GetMenusCubit.get(
                                                                            context)
                                                            ...
                                                            : Center(
                                                                child: Text(
                                                                  'لا تتوفر قائمة طعام لهذا المطعم',
                                                                  style:
                                                                      TextStyle(
                                                                    color: Colors
                                                                        .grey,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'قائمة الطعام',
                                  style: TextStyle(
                                      fontSize: 10, color: HexColor('#6259A8')),
                                )
                              ],
                            ),
                          ),
